...
var myName = ['jon','zerek','julie','adrian','sharina'];
...
while (i < myName.length) {
  if (found === true) {
    ...
    var askName = prompt('What do you know about me?\n\nQuestion 1:  What is my name?\n(You can enter any name you would like)');
    for (var j = 0; j < myName.length; j++) {
      if (myName[j] === askName.toLowerCase()) {
        found = true;
        break;
      } //else {
      //   //Apply debug
